# MobiMIND-S1 Research Roadmap

- **v0.1**: Control Baseline & Pipeline Verification (Completed)
...
- **v0.3-R1**: Truth-First Empirical Capacity Rerun on Physical Hardware (Proxy Kernel Audit Completed)
- **v0.3-R2**: True Model-on-Device Validation (Full ONNX Weights Executed via Native Runtime Completed)
...
- **v0.7**: Audio Event & Voice Perception Subsystem
- **v0.8**: Long-Horizon Multi-Step Agent Execution & Recovery
- **v1.0**: Integrated MobiMind Mobile System-1 Agent
